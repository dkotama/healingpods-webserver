...
from heartrate import hr


app = Flask(__name__)
CORS(app)

# app.register_blueprint(walkingpad, url_prefix='/api/walkingpad')
app.register_blueprint(hr, url_prefix='/api/heartrate')
...
def patient_detail():
    ...
    return render_template('/admin/patient.html', patient=patient_id)
...
if __name__ == '__main__':
    app.run(debug=True, host='0.0.0.0', port=8083, processes=1, threaded=False)
    # APP.run(debug=True)
